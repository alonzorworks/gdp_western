...
The population was another interesting factor to study. The population of the US was dramatically bigger than any other western country studied. The second biggest population studied was Germany, however, the US was over 3 times bigger in terms of population. This may have to do with the landmass of the United States. The US is bigger than the European Union (which comprises most of the western countries) and is only slightly smaller than the European continent. Surprisingly the United States is even bigger than the continent of Australia. However, Australia becomes sparsely populated on its islands because of the insufferable climate and fewer resources, compelling most of its inhabitants to prefer the coast.
...
The term Western is widely used but means different things depending on who is being talked to. Some would say Western country is any country that is located in the western hemisphere. Others say Western countries are countries that were against the Soviet Union before it collasped. 
...
Also a dollar in per capita GDP increase, increases the life span of western citizens more on average than it does their non-western counterparts. Succintly that means that western countries gain more time on earth per dollar increase in per capita GDP on average, than non-western countriees. \n
Non-Western regression and the regression for all countries have similar values for virtually if not all of the OLS calculation, so those countries do not skew the data in that regard. (Meaning although western countries have better metrics in various facets it does not bring up the depressed levels caused by the lower average of the rest of the world).
